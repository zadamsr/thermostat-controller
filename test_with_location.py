...
endpoints = [
    f"/v2/devices/thermostats/{device_id}",
    f"/v2/locations/{location_id}/devices/{device_id}",
    f"/v2/locations/{location_id}/thermostats/{device_id}",
]
